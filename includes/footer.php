...
<li><a href="https://urbanstalls.com/sellerdetail.php"><i class="icon fa fa-sign-in"></i>&nbsp Feedback Seller</a></li> -->              </a>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Brought To You By <a href="./">Friends Store </a></p>
...
<div class="contact-timing">
	...
	<div class="module-body outer-top-xs">
		<div class="table-responsive">
			<table class="table">
				<tbody>
					<tr><td>Sunday-Thursday:</td><td class="pull-right">10:00AM To 010:00PM</td></tr>
					<tr><td>Friday:</td><td class="pull-right">OFF Day</td></tr>
					<tr><td>Satureday:</td><td class="pull-right">10:00PM To 06:00PM</td></tr>
				</tbody>
			</table>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+880) 1755238730<br>(+880) 1755238730</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="https://friends-store.com/">www.friends-store.com</a></span>
                </div>
            </li>
...
<!-- ============================================================= INFORMATION : END ============================================================= -->            	</div><!-- /.col -->
    ...
    <div class="footer">
		<div class="container text-center pb-4">
			...
			<b class="copyright">&copy; 2022 Friends Store </b> All rights reserved.
		</div>
	</div>